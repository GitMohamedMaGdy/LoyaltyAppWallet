...
namespace Loyalty.Services.Migrations
{
    ...
    [Migration("20220406102543_addregisterationtable2")]
    partial class addregisterationtable2
    {
            ...
            modelBuilder.Entity("Loyalty.Domain.Models.Registration", b =>
                {
                    ...
                    b.Property<string>("DeviceLibraryIdentifier1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("PassTypeIdentifier1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DeviceLibraryIdentifier1");

                    b.HasIndex("PassTypeIdentifier1");
            ...
            modelBuilder.Entity("Loyalty.Domain.Models.Registration", b =>
                {
                    b.HasOne("Loyalty.Domain.Models.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceLibraryIdentifier1");

                    b.HasOne("Loyalty.Domain.Models.Pass", "Pass")
                        .WithMany()
                        .HasForeignKey("PassTypeIdentifier1");
                });
